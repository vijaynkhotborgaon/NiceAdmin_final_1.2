...
<a href="Edit_Activity.php?role_name=<?php echo $row_role['role_name'];?>"><input type="submit" class="btn btn-info" value="Edit Activities and Privileges"></a>
...
<td colspan="3"><strong>Privileges</strong></td>
